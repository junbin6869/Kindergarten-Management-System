...
INSERT OR IGNORE INTO classes (id, name, age_group, teacher_id) VALUES
  (1, 'K1 Sunflower', '4 years old', 2),
  (2, 'K2 Daisy', '5 years old', 3),
  (3, 'K3 Orchid', '6 years old', 4);

INSERT OR IGNORE INTO parents (id, full_name, phone, email, user_id) VALUES
...
INSERT OR IGNORE INTO students (id, full_name, date_of_birth, status, kindergarten_class_id) VALUES
...
INSERT OR IGNORE INTO student_parent (student_id, parent_id) VALUES
  (1, 1),
  (2, 2),
  (2, 6),
  (3, 3),
...
INSERT OR IGNORE INTO attendance_records (id, student_id, attendance_date, status, check_in_time, remark) VALUES
...
INSERT OR IGNORE INTO invoices (id, student_id, billing_month, billing_detail, amount, due_date, status) VALUES
  (1, 1, '2026-06', 'Tuition fee', 650.00, '2026-06-10', 'PENDING'),
  (2, 2, '2026-06', 'Tuition fee', 580.00, '2026-06-10', 'PAID'),
  (3, 3, '2026-06', 'Tuition fee', 720.00, '2026-06-10', 'PENDING'),
  (4, 4, '2026-06', 'Tuition fee', 650.00, '2026-06-10', 'FAILED'),
  (5, 5, '2026-06', 'Tuition fee', 580.00, '2026-06-10', 'PAID'),
  (6, 6, '2026-06', 'Tuition fee', 720.00, '2026-06-10', 'PAID'),
  (7, 7, '2026-06', 'Tuition fee', 650.00, '2026-06-10', 'PENDING'),
  (8, 8, '2026-06', 'Tuition fee', 580.00, '2026-06-10', 'PENDING'),
  (9, 9, '2026-06', 'Tuition fee', 720.00, '2026-06-10', 'PAID'),
  (10, 1, '2026-05', 'Tuition fee', 650.00, '2026-05-10', 'PAID'),
  (11, 2, '2026-05', 'Tuition fee', 580.00, '2026-05-10', 'PAID'),
  (12, 3, '2026-05', 'Tuition fee', 720.00, '2026-05-10', 'PAID'),
  (13, 4, '2026-05', 'Tuition fee', 650.00, '2026-05-10', 'PAID'),
  (14, 7, '2026-05', 'Misc fee', 650.00, '2026-05-10', 'FAILED');

UPDATE invoices SET billing_detail = 'Tuition fee' WHERE billing_detail IS NULL OR billing_detail = '';

INSERT OR IGNORE INTO payments (id, invoice_id, stripe_session_id, amount, status, paid_at) VALUES
